...
class JointServoNode(Node):
    ...
    def go_to_fertilizer(self):
        ...
        base_target = -4.854943698943046
        upper_link_target = -1.3448412371542418
        forearm_target = -1.7675928442503792
        ...
        cmd.velocities = [speed1, speed2, speed3, 0.0, 0.0, 0.0]
        self.joint_pub.publish(cmd)

        return self.reached([base_target, upper_link_target, forearm_target], [0,1,2])
    ...
    def fetch_all_fruit_tfs(self):
        ...
        for fruit_id in range(1, MAX_FRUIT_ID + 1):
            ...
            try:
                ...
                above_fruit_pose = [t.x, t.y, t.z+0.15, r.x, r.y, r.z, r.w]
    ...
    def control_loop(self):
        ...
        # STATE 2 
            ...
            target_pose = [0.032102, -0.23049, 0.54328, 0.59939, 0.28113, 0.27379, 0.69766]
